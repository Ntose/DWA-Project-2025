...
namespace WebAPI.Controllers
{
    ...
    public class CulturalHeritageController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create([FromBody] CulturalHeritageCreateDto createDto)
        {
            ...
            {
                ent.CulturalHeritageTopics.Add(new CulturalHeritageTopic { TopicId = topicId });
            }
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] CulturalHeritageUpdateDto updateDto)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            ...
            {
                ent.CulturalHeritageTopics.Add(new CulturalHeritageTopic
                {
                    CulturalHeritageId = id,
                    TopicId = topicId
                });
            }
